      ...
      <div className="flex flex-col gap-6 w-full md:w-1/2 text-white relative top-10">
        ...
        <div className="flex flex-row gap-4 items-center ">
          <img
            src={MoneyIcon}
            alt="Money Icon"
            className="rounded-full bg-white border w-10 h-10 p-2"
          />
        ...
        <div className="md:pt-5  text-center">
          <button className="border border-white rounded-md bg-white text-[#3969FD] font-semibold md:px-5 md:py-3 px-30 py-2">
            Get Started
          </button>
        </div>
      </div>
